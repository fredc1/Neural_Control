...
from dynamics import InvertedPendUnforced, InvertedPendSinForce, InvertedPendNNControl

t,x,theta = InvertedPendNNControl(t_final=50, t_step=0.1, i_conditions=[0, 0, np.pi + np.pi/20, 0]).get_data()
n_steps = len(t)
